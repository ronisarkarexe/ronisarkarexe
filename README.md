<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=534AB7&height=120§ion=header&text=&fontSize=0" />
...
I'm a passionate software engineer who loves building clean, efficient, and scalable web applications. I enjoy working across the entire stack — from crafting polished UIs to designing robust backend APIs and databases.

- 🔭 Currently working on **cross-border fintech & remittance apps** with NestJS, PostgreSQL, and Web3
- 🌱 Currently exploring **blockchain protocols, DeFi patterns, and AI-powered features**
- 💬 Ask me about **TypeScript, NestJS, PostgreSQL, React, Web3, or smart contracts**
...
<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=534AB7&height=100§ion=footer" />
